...
//Camera camera(glm::vec3(G_OFFSET_X + G_X / 2.0f, G_Y, G_OFFSET_Z + G_Z / 2));
Camera camera(glm::vec3(G_OFFSET_X + G_X / 2.0f - 0.5f, G_OFFSET_Y + G_Y - 0.5f, G_OFFSET_Z + G_Z / 2.0f - 0.5f), glm::vec3(0.0f, 0.0f, 1.0f), G_X > G_Z ? G_X / sqrt(2) : G_Z / sqrt(2));
...
int main()
{
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        // Text
        textShader.use();
        RenderText(textShader, "Score: 0", 10.0f, currScrHeight - 48.0f, 1.0f, glm::vec3(0.6f, 0.3f, 1.0f));
        ...
        projection = glm::ortho(-16.0f, 16.0f, -16.0f * currScrHeight / currScrWidth, 16.0f * currScrHeight / currScrWidth, 0.1f, 100.0f);
